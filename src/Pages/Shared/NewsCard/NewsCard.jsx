...
const NewsCard = ({ news }) => {
     ...
     return (
          <div className="">
               <div className="flex flex-col  space-y-6 overflow-hidden rounded-lg shadow-md mb-5">
                    <div className="flex flex-wrap justify-between p-4 px-5 bg-[#F3F3F3]">
                    ...
                    <div className="px-5">
                         <h2 className="mb-1 text-xl font-semibold">
                              { 
                                   title.length > 50 
                                   ? <h2>{title.slice(0,50)}
                                   <Link className="text-violet-500 font-medium text-sm pl-2" 
                                   to={`/news/${_id}`}>Dtail...</Link>
                                   </h2>
                                   :
                                   <h2>{title}</h2>
                              }
                         ...
                         <div className="text-sm dark:text-gray-400">
                              {
                                   details.length > 200
                                        ...
                                        to={`/news/${_id}`}
                                        className="text-violet-500 font-medium text-sm pl-2">Read More...</Link></p>
                                        :
                                        <p>{details}</p>
                              }
                         </div>
                    ...
                    <div className="flex flex-wrap justify-between">
                         ...
                         <div className="flex space-x-2 text-sm px-5 p-4 dark:text-gray-400">
